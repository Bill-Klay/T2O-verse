            ...
            <div className="relative flex justify-center items-center">
              <OTPInput
                ...
                renderInput={(props) => (
                  <input
                    {...props}
                    className="border border-strokedark rounded-md"
                    // className="w-full rounded-md border border-strokedark bg-transparent py-3 pl-4 pr-10 text-black  outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                  />
                )}
              />
              {/* <input
